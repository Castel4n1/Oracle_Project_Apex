...
/
ALTER TABLE  "PRODUTO" ADD CONSTRAINT "FKECATEGORIA" FOREIGN KEY ("CATEGORIA_ID")
	  REFERENCES  "CATEGORIA" ("ID") ENABLE
/
ALTER TABLE  "PRODUTO" ADD CONSTRAINT "FKEPRODUTO" FOREIGN KEY ("MARCA_ID")
	  REFERENCES  "MARCAS" ("ID") ENABLE
/
